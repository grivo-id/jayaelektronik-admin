...
export const getCreateProductSchema = () =>
    z.object({
        ...
        product_image1: z.string().min(1, 'At least one product image is required').nullable(),
...
export const getUpdateProductSchema = () =>
    z.object({
        ...
        product_promo_final_price: z.number(),
        product_promo_expired_date: z.string().nullable(),
        product_image1: z.any().nullable(),
        product_image2: z.any().nullable(),
        product_image3: z.any().nullable(),
    });
