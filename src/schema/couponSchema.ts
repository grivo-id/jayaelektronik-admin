...
export const getCreateCouponSchema = () =>
    z.object({
        ...
        coupon_min_product_qty: z.number().int().min(0, 'Minimum product quantity must be at least 0'),
        ...
        coupon_max_used: z.number().int().min(0, 'Maximum usage count must be at least 0'),
